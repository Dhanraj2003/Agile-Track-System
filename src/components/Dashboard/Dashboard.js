...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchScrums = async () => {
            try {
                const response = await axios.get('https://agile-track-system-1.onrender.com/scrums');
    ...
    const handleGetDetails = async (scrumId) => {
        try {
            const response = await axios.get(`https://agile-track-system-1.onrender.com/scrums/${scrumId}`);
    ...
    const handleAddScrum = async (event) => {
        ...
        try {
            // Add new Scrum
            const newScrumResponse = await axios.post('https://agile-track-system-1.onrender.com/scrums', {
                name: newScrumName,
            });
            ...
            // Add new Task
            await axios.post('https://agile-track-system-1.onrender.com/tasks', {
                title: newTaskTitle,
            ...
            const updatedScrums = await axios.get('https://agile-track-system-1.onrender.com/scrums');
